...
for i in range (0, 100) :
    ...
    if lj.force_calls < 10000 :
        total_force_calls += lj.force_calls
        print str(i+1)+'. Force calls : ', lj.force_calls
        cnt += 1
    #print str(i+1)+'. Final potential Energy :', p_e
    #print '   Final magnitude of vector :', vec
    #print '   Final position : '
    #print pos
print 'Average force calls : ', total_force_calls/cnt
print 'Total atoms : ', cnt 
