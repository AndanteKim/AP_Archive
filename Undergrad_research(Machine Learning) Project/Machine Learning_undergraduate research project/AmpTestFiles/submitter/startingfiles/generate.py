...
def generate_data_optimization(filename,ljcluster,inter,forcemax,maxstep,numberofstructures):
	...
	for i in range(startnumb,1000,2):
...
def create_train(trainingset,trainingsetname,trainingstructure,trainingnumber,inter=20,forcemax=0.01,maxstep=0.1,temperature=2000,timestep=0.01):
...
def create_test(testset,testingsetname,testingstructure,testingnumber,inter=20,forcemax=0.01,maxstep=0.1,temperature=2000,timestep=0.01):
