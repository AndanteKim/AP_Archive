...
def main_ML(temp, ts):
    ...
    SDLBFGS_gen.trainingsetname = trainingsetname
    SDLBFGS_gen.testingsetname = testingsetname
   ...
   #call function in generate.py to create training sets as MD method
    ...
    SDLBFGS_gen.create_train(trainingset,trainingsetname,trainingstructure,trainingnumber,inter,forcemax,maxstep,temperature,timestep)
    ...
    new_trainingset, new_testset = SDLBFGS_gen.switch_type(trainingset, testset)
    ...
    SDLBFGS_gen.create_train(new_trainingset,trainingsetname,trainingstructure,trainingnumber,inter,forcemax,maxstep,temperature,timestep)
    print('training amp')
    ...
    SDLBFGS_gen.create_test(new_testset,testingsetname,testingstructure,testingnumber,inter,forcemax,maxstep,temperature,timestep)
