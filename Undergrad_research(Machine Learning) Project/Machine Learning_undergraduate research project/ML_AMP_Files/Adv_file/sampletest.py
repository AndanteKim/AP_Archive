...
def test_amp(calc,testingsetname,testingnumber,plottitle,plotfigure):
    ...
    n, bins, patches = plt.hist(lennardjones, bins_conf, range=(Min_len,Max_len), color = 'skyblue', alpha = 0.5, rwidth = 0.85, histtype='bar')
    ...
    plt.ylabel('The number of training set about LJ')
    plt.title(plottitle)
    plt.subplots_adjust(bottom=0.15)
    #save as .png file about the histogram
    plt.savefig("./Opt_Collection/"+plotfigure)
