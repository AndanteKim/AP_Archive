...
def main_ML(temp):
    ...
    plotfiguresuffix = 'HistoLJ38_MD_FIRE_1000.png'
    ...
    trainingstructure='structures/lj3' #lj structure used to train
    testingstructure='structures/lj3' #lj structure used to test

    trainingnumber=1000 #number of data points for training
    testingnumber=1000 #number of data points for testing
    ...
    generate.create_train(new_trainingset,trainingsetname,trainingstructure,trainingnumber,inter,forcemax,maxstep,temperature,timestep)
    print('training amp')
    ...
    generate.create_test(new_testset,testingsetname,testingstructure,testingnumber,inter,forcemax,maxstep,temperature,timestep)	
